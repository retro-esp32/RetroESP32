...
Suppose that this is the normal command used to flash plaintext data::
  ...
  esptool.py --port /dev/cu.usbserial-AB0JECDI --baud 115200 write_flash 0x10000 build/my-app.bin
...
Then, flash the encrypted binary with esptool.py::
    ...
    esptool.py --port /dev/cu.usbserial-AB0JECDI --baud 115200 write_flash 0x10000 build/my-app-encrypted.bin
